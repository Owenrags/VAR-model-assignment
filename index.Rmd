...
Taking a step back from the analysis conducted above we can conclude the VAR model did in fact confirm the expected outcome that employment does cause retail sales: alcoholic beverages. However, it also gave us a more convincing argument that retail sales of alcoholic beverages has a larger impact on unemployment. It is my belief that this finding suggest that retail sales as a whole, not just alcoholic beverages, have an impact on unemployment. This would be consistent with economic theory that would suggest that consumers stop purchasing as many goods when they become unemployed, due to lack of income. In order to confirm this we would need to gather new variables and more data to test this expectation.  
